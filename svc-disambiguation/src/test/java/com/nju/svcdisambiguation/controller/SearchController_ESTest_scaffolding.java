...
public class SearchController_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.nju.svcdisambiguation.controller.SearchController"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(SearchController_ESTest_scaffolding.class.getClassLoader() ,
      "com.nju.svcdisambiguation.vo.ResponseVO",
      "com.nju.svcdisambiguation.po.ieee.IEEEPaperPO",
      "com.nju.svcdisambiguation.controller.SearchController",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.nju.svcdisambiguation.dataMapper.acm.ACMSearchMapper", false, SearchController_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.nju.svcdisambiguation.dataMapper.ieee.IEEESearchMapper", false, SearchController_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(SearchController_ESTest_scaffolding.class.getClassLoader()); 
