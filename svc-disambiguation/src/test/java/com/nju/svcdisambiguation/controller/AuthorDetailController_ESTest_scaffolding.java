...
public class AuthorDetailController_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.nju.svcdisambiguation.controller.AuthorDetailController"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(AuthorDetailController_ESTest_scaffolding.class.getClassLoader() ,
      "com.nju.svcdisambiguation.vo.detail.author.AuthorPublicationSummaryVO",
      "com.nju.svcdisambiguation.controller.AuthorDetailController",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.nju.svcdisambiguation.dataMapper.acm.ACMAuthorDetailMapper", false, AuthorDetailController_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.nju.svcdisambiguation.dataMapper.ieee.IEEEAuthorDetailMapper", false, AuthorDetailController_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(AuthorDetailController_ESTest_scaffolding.class.getClassLoader()); 
